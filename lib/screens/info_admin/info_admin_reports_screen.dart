    ...
    return RefreshIndicator(
      ...
      child: ListView(
        ...
        children: [
          ...
          const Text('Ventas de hoy', textAlign: TextAlign.center, style: TextStyle(color: const Color(0xFF616161))),
            ...
            children: [
              Column(
                children: [
                  ...
                  const Text('Ventas', style: TextStyle(color: const Color(0xFF616161), fontSize: 12)),
                ],
              ),
              Column(
                children: [
                  CurrencyText(summary.averageTicket, bold: true, style: const TextStyle(fontSize: 22)),
                  const Text('Ticket promedio', style: TextStyle(color: const Color(0xFF616161), fontSize: 12)),
                ],
              ),
            ],
          ),
          ...
          if (summary.byPaymentMethod.isEmpty)
            const Text('Sin ventas todavía', style: TextStyle(color: const Color(0xFF616161)))
          else
