...
class DiscountManagerDialog extends StatefulWidget {
  const DiscountManagerDialog({super.key});

  @override
  State<DiscountManagerDialog> createState() => _DiscountManagerDialogState();
}

class _DiscountManagerDialogState extends State<DiscountManagerDialog> {
        ...
        child: Column(
          children: [
            TextField(
              ...
              decoration: const InputDecoration(labelText: 'Nombre (ej. Promo verano)'),
            ),
              ...
              children: [
                ...
                Expanded(
                  child: TextField(
                    ...
                    decoration: InputDecoration(labelText: _type == 'percentage' ? 'Valor %' : 'Valor \$'),
                  ),
                ),
                IconButton(
                  icon: _saving
